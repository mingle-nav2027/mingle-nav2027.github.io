...
SCENARIOS = [
    ...
    ("corridor_half_successful_trial_12m_01", "Corridor turn, 1.2 m passage", "turn", "success",
     "The robot comes round into a passage barely wider than two bodies and meets the pedestrian inside it, making room without stopping short of the turn."),
    ("corridor_half_successful_trial_12m_02", "Corridor turn, 1.2 m passage (trial 2)", "turn", "success",
     "A second run in the 1.2 m passage with a different starting offset; the robot settles onto one side and passes the pedestrian."),
